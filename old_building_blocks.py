...
class TemporalMemoryLayer(ColumnarLayer):
    ...
    def _activate_cells(self, learn: bool) -> None:
        ...
        for col_idx in self.active_columns:
            ...
            if predicted_cells:
                ...
                if learn:
                    # This will select the cell with a segment that has most synapses to prev active cells
                    # if there are none it will select the cell with fewest segments
        ...
        if learn:
            ...
            for winner in bursting_winners:
                ...
                # if the segment doesn't have enough synapses (<learning_threshold), create a new one
                # and learn on that segment 
    ...
    def _learn_on_cell(self, cell: Cell, prev_active_cells: Set[Cell]) -> None:
        ...
        # if the segment doesn't have enough synapses (<learning_threshold), create a new one
        # and learn on that segment 
        # Basically learn on the best segment 
